...
export default function LoginPage() {
  ...
  const handleGoogleClick = () => {
    if (!GOOGLE_CLIENT_ID) {
      setError("Google Sign-In is not configured yet. Use email/password or demo accounts.");
      return;
    }
    ...
    <div className="auth-page">
      ...
      <div className="auth-container">
        <div className="auth-card">
          ...
          <button className="auth-btn auth-btn-google" onClick={handleGoogleClick} disabled={loading}>
